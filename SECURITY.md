...
**Found a vulnerability?** Email **security@meshtool.dev** with details and a proof-of-concept. Please don't open a public issue for security reports, and give us a reasonable window to fix before disclosure. We credit reporters (or keep you anonymous — your call).
